...
> ![在这里插入图片描述](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9pbWFnZXMucHRhdXNlcmNvbnRlbnQuY29tLzI5?x-oss-process=image/format,png#pic_center)
![图1](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9pbWFnZXMucHRhdXNlcmNvbnRlbnQuY29tLzI4?x-oss-process=image/format,png#pic_center)
现在给定两棵树，请你判断是否是同构的。
